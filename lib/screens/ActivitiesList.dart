      ...
      body: SafeArea(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(children: [
                      ...
                      child: ElevatedButton(
                        ...
                        child: Row(
                          ...
                          children: const <Widget>[
                            ...
                            Text("Day 1",style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        padding: const EdgeInsets.symmetric(horizontal: 20,vertical: 30),
                        elevation: 0,
                        foregroundColor: const Color.fromARGB(255, 142, 146, 151)),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: const <Widget>[
                            
                            // Espacio entre el icono y el texto
                            Text("Day 2",style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                    ),
                ...
                // text
                const Text('Create a new activity',
                          style: TextStyle(
                          color: Colors.grey,
                          fontSize: 20,
                          fontWeight: FontWeight.bold

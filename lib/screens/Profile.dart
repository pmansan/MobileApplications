         ...
         child: Container(
          ...
          child: Column(
            ...
            children: [
                ...
                //Title text
                Padding(
                  padding: const EdgeInsets.only(left: 30.0,bottom: 20,top:30 ),
                  child: Row(
              ...
              const CircleAvatar(
                        backgroundImage: NetworkImage('https://img.freepik.com/foto-gratis/mujer-hermosa-joven-mirando-camara-chica-moda-verano-casual-camiseta-blanca-pantalones-cortos-hembra-positiva-muestra-emociones-faciales-modelo-divertido-aislado-amarillo_158538-15796.jpg'),
                        radius: 70.0, // El radio determina el tamaño de la imagen circular
                      ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  backgroundColor: Colors.white,
                  padding: const EdgeInsets.only(left:0,right:80,top: 20,bottom: 20),
                  elevation: 0,
            ...
            SizedBox(
                ...
                child: Container(
                  ...
                  margin: const EdgeInsets.symmetric(horizontal: 150, vertical: 0),
